...
class Person extends Card
{
  ...
  public Person(String name)
  {
    ...
    {
      bio="The aging Mrs. Peacock had always loved to be the center of attention. That meant knowing any and all of the gossip related to the residents of Yorkshire. But even she was shocked to hear rumors going around the town that Mr. Boddy, her husband’s longtime business partner, had began selling alcohol in America which had been locked in Prohibition. She was equal parts shocked and amused, that the shrewd Mr. Boddy had potentially decided to undertake such a risky new venture. It was a few moments later that she realized if the claims were in fact true, and if Mr. Boddy was caught, his selfish decision could destroy the reputation of not only her husband’s shared business, but their social standing as well. ";
      alibi="At the time of the murder Mrs. Peacock was seen by numerous domestic servants prying the maid Theresa if she had heard anything about the rumors. The murderer remains on the loose. ";
      guilty="Mrs. Peacock felt numb after reading the tinged and mangled piece of paper she’d been given by one of Mr. Boddy’s servants. She was told by the servant that she was instructed to throw several documents in the fireplace in front of Mr. Boddy. She reluctantly obliged. But as soon as he left she had managed to pull the top paper from the fireplace and smuggle it out. The rumors were true. Mrs. Peacock knew what she had to do. She calmly found Mr. Boddy and killed him with the ";
      guilty_pt2 = " in the ";
    }
    ...
    else if(name.equals("Mr. Green"))
    {
      ...
      guilty="The reverend found his old friend. It felt surreal to see him in the flesh after so many years. Before he could so much as utter a single word Mr. Boddy scoffed that the reverend was a stupid fool, who hadn’t amounted to anything. He then calmly began to call for a servant to remove the Reverend. Something inside him snapped. That was the final straw; Reverend Green had taken enough. He took the ";
...
class Weapon extends Card
{
  public Weapon(String name)
  {
    ...
    {
      alibi=" Paranoid in recent weeks, Mr. Boddy had all firearms locked away in a vault located in the cellar. This included his prized revolver. No one, but him, knew where the key was located. Mr. Boddy’s prized Colt M1911 revolver was not the weapon that ended his life. ";
    }
    else if(name.equals("Rope"))
    {
      alibi=" A terrible storm a week earlier had destroyed a portion of the fence surrounding the pasture adjacent to the estate. As such, the horses had to be stabled inside, and the rope was taken to tie them up. The rope was not the weapon that ended Mr. Boddy’s life. ";
    }
    else if(name.equals("Wrench"))
    {
      alibi=" The estate next to the Tudor mansion was undergoing extensive renovation and a servant had come over a few days prior requesting a wrench. The groundsman of the Tudor Mansion happily obliged. The wrench was not the weapon that ended Mr. Boddy’s life. ";
    }
    else{
...
class Room extends Card
{
  ...
  public Room(String name)
  {
    ...
    else if(name.equals("Dining Room"))
    {
      ...
      column=3;
      row=2.5;
      alibi=" At the time of the murder a few maids were preparing the dinner table by laying out the silverware, delicate wine gauntlets, gold chargers, and freshly pressed linens. The dining room did not bear witness to the murder of Mr. Boddy.";
    }
